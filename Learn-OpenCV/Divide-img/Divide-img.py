...
img = cv2.imread("D:/Github/Opencv/Learn-OpenCV/Divide-img/test.jpg")
...
for y in range(0, img_height, patch_height):
    for x in range(0, img_width, patch_width):
        ...
        if x1 >= img_width and y1 >= img_height:
            ...
            cv2.imwrite('D:/Github/Opencv/Learn-OpenCV/Divide-img/output/'+'tile'+str(x)+'_'+str(y)+'.jpg', tiles)
...
cv2.imwrite("D:/Github/Opencv/Learn-OpenCV/Divide-img/output/patched.jpg",img)
